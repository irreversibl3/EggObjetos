 ...
 * de la palabra: 6 Mensaje: La letra no pertenece a la palabra Número de letras
 * (encontradas, faltantes): (4,3) Número de oportunidades restantes: 1
 * ---------------------------------------------- Ingrese una letra: q Longitud
 * de la palabra: 6 Mensaje: La letra no pertenece a la palabra Mensaje: Lo
 * sentimos, no hay más oportunidades
 *
 */
public class Ahorcado {
    ...
    public String[] getPalabraAhor() {
        return palabraAhor;
    }

    public void setPalabraAhor(String[] palabraAhor) {
        this.palabraAhor = palabraAhor;
    }
